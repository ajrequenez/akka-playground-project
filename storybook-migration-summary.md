...
- `npx storybook@latest automigrate --config-dir apps/sample-ui/.storybook --renderer @storybook/react`

- `npx storybook@latest automigrate --config-dir apps/sample-ng-ui/.storybook --renderer @storybook/angular`
